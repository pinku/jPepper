...
(function (_, window) {
            ...
            var jPWebApp = function jPWebApp(_) {
                        ...
                        var ERRORS = ["ERRCODE 1 - jPepper.webapp.initFromHtml: No DATA-TYPE attribute specified in the TAG", "ERRCODE 2 - jPepper.webapp.initFromHtml: DATA-TYPE attribute does not match any suitable value", "ERRCODE 3 - jPepper.webapp.jPForm.initFromHtml: no DATA-TYPE attribute specified in the TAG or wrong value specified. DATA-TYPE must be 'jpform'"];

                        //#region New tags definition

                        var jPFormTag = document.registerElement("jpc-form");

                        //#endregion

                        //#region jPControl

                        var jPControl = function jPControl(args) {};
                        ...
                        jPControl.p.init = function (args) {
                                    ...
                                    if (this.opt.id === undefined || this.opt.id == "") {
                                                this.opt.id = _.newGUID();
                                    }
                        ...
                        jPControl.p.initFromHtml = function (sel) {
                                    ...
                                    // controlla che sia un jpcontrol
                                    var type = el.dattr("type");

                                    // in caso di errore
                                    if (type == null || type == "") {
                                                var err = new _.Error("jPepper.webapp.jPControl.initFromHtml", "1", ERRORS[0])["throw"]();
                                                return;
                                    }

                                    //#region opzioni del controllo

                                    // oggetto per le opzioni del controllo
                                    var opt = {};
                                    ...
                                    // visible
                                    var visible = el.dattr("visible");
                                    opt.visible = visible == null || visible == 1 || visible == "true" ? true : false;

                                    // classe css
                                    var cssclass = el.attr("class");
                                    opt.cssclass = cssclass == null ? "" : cssclass;

                                    //#endregion

                                    // a seconda del TYPE instanzia il controllo
                                    type = type.toLowerCase();
                                    switch (type) {
                                                case "jpform":
                                                            return new jPForm(opt).initFromHtml(sel);
                                                            break;
                                                default:
                                                            var err = new _.Error("jPepper.webapp.jPControl.initFromHtml", "2", ERRORS[1])["throw"]();
                                                            return;
                                    }
                        ...
                        jPControl.p.render = function () {
                                    ...
                                    if (!this.triggerEvent(EVT_BEF_RENDER)) {
                                                return;
                                    }

                                    this.el = _["new"](this.opt.tag);
                                    this.el.attr(DATATYPE, this.opt.type).attr(DATAID, this.opt.id);
                        ...
                        jPControl.p.show = function () {
                                    ...
                                    if (!this.triggerEvent(EVT_BEF_SHOW)) {
                                                return;
                                    }
                        ...
                        jPControl.p.hide = function () {
                                    ...
                                    if (!this.triggerEvent(EVT_BEF_HIDE)) {
                                                return;
                                    }
                        ...
                        var jPForm = function jPForm(args) {
                                    this.init(args);
                        };
                        ...
                        jPForm.p.initFromHtml = function (sel) {

                                    // oggetto jPepper
                                    var el = _(sel);

                                    // controlla che sia un jpform
                                    var type = el.dattr("type").toLowerCase();

                                    // in caso di errore
                                    if (type == null || type.toLowerCase() != "jpform") {
                                                var err = new _.Error("jPepper.webapp.jPForm.initFromHtml", "3", ERRORS[2])["throw"]();
                                                return;
                                    }
                        ...
                        var jPSection = function jPSection(args) {
                                    this.init(args);
                        };
                        ...
                        var jPText = function jPText(args) {
                                    this.init(args);
                        };
                        ...
                        var jPTextBox = function jPTextBox(args) {
                                    this.init(args);
                        };
                        ...
                        var jPButton = function jPButton(args) {
                                    this.init(args);
                        };
                        ...
                        jPButton.p.render = function () {
                                    ...
                                    this.el.attr("href", "#").innerHTML(this.opt.caption);
                                    this.bindevents();
                        ...
                        var jPImage = function jPImage(args) {
                                    this.init(args);
                        };
