...
(function (_, window) {
    ...
    var jPWebApp = function (_) {
        ...
        var ERRORS = [
            "ERRCODE 1 - jPepper.webapp.initFromHtml: No DATA-TYPE attribute specified in the TAG",
            "ERRCODE 2 - jPepper.webapp.initFromHtml: DATA-TYPE attribute does not match any suitable value",
            "ERRCODE 3 - jPepper.webapp.jPForm.initFromHtml: no DATA-TYPE attribute specified in the TAG or wrong value specified. DATA-TYPE must be 'jpform'"
        ];
